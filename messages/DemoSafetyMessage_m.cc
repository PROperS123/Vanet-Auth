...
Register_Class(EncryptedSafetyMessage)

EncryptedSafetyMessage::EncryptedSafetyMessage(const char *name, short kind) : ::veins::BaseFrame1609_4(name, kind)
{
}

EncryptedSafetyMessage::EncryptedSafetyMessage(const EncryptedSafetyMessage& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}

EncryptedSafetyMessage::~EncryptedSafetyMessage()
{
}

EncryptedSafetyMessage& EncryptedSafetyMessage::operator=(const EncryptedSafetyMessage& other)
{
    if (this == &other) return *this;
    ::veins::BaseFrame1609_4::operator=(other);
    copy(other);
...
void EncryptedSafetyMessage::copy(const EncryptedSafetyMessage& other)
{
    this->eMSG = other.eMSG;
}

void EncryptedSafetyMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::veins::BaseFrame1609_4::parsimPack(b);
    doParsimPacking(b,this->eMSG);
}

void EncryptedSafetyMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::veins::BaseFrame1609_4::parsimUnpack(b);
    doParsimUnpacking(b,this->eMSG);
}

const char * EncryptedSafetyMessage::getEMSG() const
{
    return this->eMSG.c_str();
}

void EncryptedSafetyMessage::setEMSG(const char * eMSG)
{
    this->eMSG = eMSG;
}

class EncryptedSafetyMessageDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
  ...
  public:
    EncryptedSafetyMessageDescriptor();
    virtual ~EncryptedSafetyMessageDescriptor();
...
Register_ClassDescriptor(EncryptedSafetyMessageDescriptor)

EncryptedSafetyMessageDescriptor::EncryptedSafetyMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::EncryptedSafetyMessage)), "veins::BaseFrame1609_4")
{
    propertynames = nullptr;
}

EncryptedSafetyMessageDescriptor::~EncryptedSafetyMessageDescriptor()
{
    delete[] propertynames;
}

bool EncryptedSafetyMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<EncryptedSafetyMessage *>(obj)!=nullptr;
}

const char **EncryptedSafetyMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *EncryptedSafetyMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int EncryptedSafetyMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int EncryptedSafetyMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_eMSG
    };
    return (field >= 0 && field < 1) ? fieldTypeFlags[field] : 0;
}

const char *EncryptedSafetyMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int EncryptedSafetyMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'e' && strcmp(fieldName, "eMSG") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *EncryptedSafetyMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **EncryptedSafetyMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *EncryptedSafetyMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int EncryptedSafetyMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    EncryptedSafetyMessage *pp = (EncryptedSafetyMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *EncryptedSafetyMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string EncryptedSafetyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    EncryptedSafetyMessage *pp = (EncryptedSafetyMessage *)object; (void)pp;
    switch (field) {
        case FIELD_eMSG: return oppstring2string(pp->getEMSG());
        default: return "";
    }
}

bool EncryptedSafetyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    EncryptedSafetyMessage *pp = (EncryptedSafetyMessage *)object; (void)pp;
    switch (field) {
        case FIELD_eMSG: pp->setEMSG((value)); return true;
        default: return false;
    }
}

const char *EncryptedSafetyMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *EncryptedSafetyMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
