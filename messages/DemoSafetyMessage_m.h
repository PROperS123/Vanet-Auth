...
/**
 * Class generated from <tt>veins/modules/messages/DemoSafetyMessage.msg:34</tt> by nedtool.
 * <pre>
 * packet EncryptedSafetyMessage extends BaseFrame1609_4
 * {
 *     string eMSG;
 * }
 * </pre>
 */
class VEINS_API EncryptedSafetyMessage : public ::veins::BaseFrame1609_4
{
  protected:
    omnetpp::opp_string eMSG;

  private:
    void copy(const EncryptedSafetyMessage& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const EncryptedSafetyMessage&);

  public:
    EncryptedSafetyMessage(const char *name=nullptr, short kind=0);
    EncryptedSafetyMessage(const EncryptedSafetyMessage& other);
    virtual ~EncryptedSafetyMessage();
    EncryptedSafetyMessage& operator=(const EncryptedSafetyMessage& other);
    virtual EncryptedSafetyMessage *dup() const override {return new EncryptedSafetyMessage(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;

    // field getter/setter methods
    virtual const char * getEMSG() const;
    virtual void setEMSG(const char * eMSG);
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const EncryptedSafetyMessage& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, EncryptedSafetyMessage& obj) {obj.parsimUnpack(b);}
