...
protected:
    ...
    /** @breif this is called upon receiving an encrypted BSM */
    virtual void onEBSM(EncryptedSafetyMessage* eBSM){
        EV_ERROR << "FROM APPLAYER.H" << endl;
    };
